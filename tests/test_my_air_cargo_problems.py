...
if __name__ == '__main__':
   # unittest.main()
    t = TestAirCargoMethods()
    t.setUp()
    t.test_AC_get_actions()
    t.test_AC_actions()
    t.test_AC_result()
    t.test_h_ignore_preconditions()
    
    t= TestAirCargoProb2()
    t.setUp()
    t.test_ACP2_num_fluents()
    t.test_ACP2_num_requirements()
    
    t= TestAirCargoProb3()
    t.setUp()
    t.test_ACP3_num_fluents()
    t.test_ACP3_num_requirements()

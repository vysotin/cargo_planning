...
if __name__ == '__main__':
    ...
    t = TestPlanningGraphLevels()
    t.setUp()
    t.test_add_action_level()
    t.test_add_literal_level()
    t = TestPlanningGraphMutex()
    t.setUp()
    t.test_inconsistent_effects_mutex()
    t.test_interference_mutex()
    t.test_competing_needs_mutex()
    t.test_negation_mutex()
    t.test_inconsistent_support_mutex()
    t=TestPlanningGraphHeuristics()
    t.setUp()
    t.test_levelsum()
